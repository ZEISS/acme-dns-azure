...
schema = Map({
    ...
    Optional('keyvault_account_secret_name', default = ''): Regex('^[-a-zA-Z0-9]{1,127}$|'), #optional / default: acme-account-${acme_server} #if non-existing or empty, certbot register will be executed, account directory will be stored as base64 tar.gz file
